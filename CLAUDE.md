...
- Always confirm which branch you're on before committing. If unsure, run `git branch --show-current` and ask the user before proceeding.
- Do not use git worktrees unless explicitly asked. Work on the current branch in the current directory.
